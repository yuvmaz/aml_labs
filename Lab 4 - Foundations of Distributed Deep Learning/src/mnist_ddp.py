...
def main():
    ...
    num_nodes = int(os.environ['AZUREML_NODE_COUNT'])

    parser = argparse.ArgumentParser()
    parser.add_argument('--gpus', default=world_size // num_nodes, type=int, metavar='N',
                        help='number of GPUs per node')
    parser.add_argument('--nodes', default=num_nodes, type=int, metavar='N',
